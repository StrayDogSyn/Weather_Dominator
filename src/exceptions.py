...
class APIKeyMissingError(ConfigurationError):
    ...
    def __init__(self, service: str):
        super().__init__(
            ...
            "Please configure the API key in config.json or environment variables",
        )
...
class DataNotFoundError(DataError):
    ...
    def __init__(self, data_type: str, identifier: str):
        super().__init__(f"{data_type} not found", f"No data found for {identifier}")
...
class InvalidCityError(InvalidInputError):
    ...
    def __init__(self, city: str):
        super().__init__("Invalid city name", f"'{city}' is not a valid city name")
        self.city = city
...
class InvalidCharacterError(InvalidInputError):
    ...
    def __init__(self, character: str):
        super().__init__(
            "Invalid character name", f"'{character}' is not a valid character name"
        )
...
class CacheFullError(CacheError):
    ...
    def __init__(self, current_size: float, max_size: float):
        super().__init__(
            "Cache is full", f"Current: {current_size}MB, Max: {max_size}MB"
        )
...
def is_recoverable(error: Exception) -> bool:
    ...
    """
    recoverable_errors = (NetworkError, RateLimitError, CacheError, DataNotFoundError)
